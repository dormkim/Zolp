...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        pass_text = findViewById(R.id.passtext);
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!name_text.getText().toString().equals("") && !pass_text.getText().toString().equals("")) {
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        for (QueryDocumentSnapshot document : task.getResult()) {
                                            if(name_text.getText().toString().equals(document.getString("name")) && pass_text.getText().toString().equals(document.getString("uniqueId"))){
                                                logincheck = true;
                                                Intent intent = new Intent(getApplicationContext(), MenuActivity.class);
                                                intent.putExtra("id_info", document.getId());
    ...
    void checkRunTimePermission(){
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(LoginActivity.this, Manifest.permission.ACCESS_FINE_LOCATION);
